...
import kotlinx.android.synthetic.main.activity_dzien.*
import kotlinx.android.synthetic.main.activity_miesiac.*
import kotlinx.android.synthetic.main.row.view.*

class dzien : AppCompatActivity() {
    lateinit var option: Spinner
    lateinit var miesiac: String

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_dzien)
        ...
        option = findViewById(R.id.spinner_dzien) as Spinner
