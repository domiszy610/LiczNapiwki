...
//                        "INNER JOIN ${Table2Info.TABLE_NAME} ON ${Table1Info.TABLE_COLUMN_ID_POSADA} WHERE ${Table1Info.TABLE_COLUMN_DATA} LIKE '%${miesiac} = ${Table2Info.TABLE_NAME}.${BaseColumns._ID} ",
//                null
//            )
